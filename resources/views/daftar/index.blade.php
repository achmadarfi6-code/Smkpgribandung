...
<section class="breadcrumbs">
  <div class="container">
    ...
    <section id="contact" class="contact pt-3 pb-3">
      <form action="{{ route('daftar.store') }}" method="post" role="form" class="php-form bg-white" enctype="multipart/form-data">
        @csrf
          ...
          <div class="form-group col-md-6">
            ...
            <div style="position:relative;">
              <a class='btn btn-primary' href='javascript:;'>
                Pilih File
                <input required id="foto" name="foto" class="form-control" type="file" style='position:absolute;z-index:2;top:0;left:0;opacity:0;' size="40" onchange='$("#upload-file-info").html($(this).val());'>
              </a>
              &nbsp;
